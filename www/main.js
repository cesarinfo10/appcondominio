...
var map = {
	...
	"./detalle-solucion/detalle-solucion.module": [
	...
	"./iniciarronda/iniciarronda.module": [
	...
	"./ronda-list/ronda-list.module": [
		"./src/app/ronda-list/ronda-list.module.ts",
		"ronda-list-ronda-list-module"
	],
	"./scanpunto/scanpunto.module": [
...
/* harmony import */ var _servicios_usuario_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./servicios/usuario.service */ "./src/app/servicios/usuario.service.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _servicios_usuario_service__WEBPACK_IMPORTED_MODULE_10__["UsuarioService"],
...
/***/ "./src/app/config/url.servicios.ts":
/*!*****************************************!*\
  !*** ./src/app/config/url.servicios.ts ***!
  \*****************************************/
/*! exports provided: URL_SERVIS */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var UsuarioService = /** @class */ (function () {
    ...
    /*VARIABLE GLOBALES*/
    UsuarioService.prototype.setrRUTvar = function (value) {
        this.usser = value;
    };
    UsuarioService.prototype.setPassVar = function (value) {
        this.pass = value;
    };
    UsuarioService.prototype.seIdUserVar = function (value) {
        this.id = value;
    };
    // ==============================================================
    // INICIAR SESION
    // ==============================================================
    UsuarioService.prototype.inicioSesion = function (name, pass) {
        var _this = this;
        this.setrRUTvar(name);
        this.setPassVar(pass);
        return new Promise(function (resolve) {
            _this.http.get(_config_url_servicios__WEBPACK_IMPORTED_MODULE_3__["URL_SERVIS"] + '/appcondominio/servicios/usuarios.php?usser=' + _this.usser + '&pass=' + _this.pass + '&session')
    ...
    // ==============================================================
    UsuarioService.prototype.consultUsuario = function () {
        var _this = this;
        return new Promise(function (resolve) {
            _this.http.get(_config_url_servicios__WEBPACK_IMPORTED_MODULE_3__["URL_SERVIS"] + '/appcondominio/servicios/usuarios.php?usser=' + _this.usser + '&pass=' + _this.pass + '&consultaUser')
                .subscribe(function (data) {
                resolve(data);
            }, function (err) {
                console.log(err);
    ...
    // ==============================================================
    UsuarioService.prototype.consultTodosUsuarios = function () {
        var _this = this;
        return new Promise(function (resolve) {
            _this.http.get(_config_url_servicios__WEBPACK_IMPORTED_MODULE_3__["URL_SERVIS"] + '/appcondominio/servicios/usuarios.php?getAll')
                .subscribe(function (data) {
                resolve(data);
            }, function (err) {
                console.log(err);
    ...
    // CONSULTA DE USUARIO (SESIÓN)
    // ==============================================================
    UsuarioService.prototype.cunsultaUserReporte = function (idUser) {
        var _this = this;
        return new Promise(function (resolve) {
            _this.http.get(_config_url_servicios__WEBPACK_IMPORTED_MODULE_3__["URL_SERVIS"] + '/appcondominio/servicios/usuarios.php?ID=' + idUser + '&consultaUserEdit')
                .subscribe(function (data) {
                resolve(data);
            }, function (err) {
                console.log(err);
    ...
    // ==============================================================
    UsuarioService.prototype.detalleReporteAdd = function (idUsuario, IDtorre, unidad, descripcion, resultadoSacan, urlImage) {
        var _this = this;
        var datos = {
        ...
        return new Promise(function (resolve) {
            _this.http.post(_config_url_servicios__WEBPACK_IMPORTED_MODULE_3__["URL_SERVIS"] + '/appcondominio/servicios/usuarios.php?nuevoReportepos', body)
                .subscribe(function (data) {
                resolve(data);
            }, function (err) {
                console.log(err);
    ...
    // ==============================================================
    UsuarioService.prototype.enviarSolucionAdd = function (usuario, desde, hasta, descripcion, urlImage) {
        var _this = this;
        var datos = {
            // tslint:disable-next-line:object-literal-key-quotes
            'usuario': usuario,
        ...
        var body = JSON.stringify(datos);
        return new Promise(function (resolve) {
            _this.http.post(_config_url_servicios__WEBPACK_IMPORTED_MODULE_3__["URL_SERVIS"] + '/appcondominio/servicios/usuarios.php?nuevoSolucionpos', body)
                .subscribe(function (data) {
                resolve(data);
            }, function (err) {
                console.log(err);
...
module.exports = __webpack_require__(/*! /Users/casv/Documents/ionic/appcondominio/src/main.ts */"./src/main.ts");
